# Homebrew formula for agentdex, destined for the org tap p3bot/homebrew-tap.
#
...
class Agentdex < Formula
  ...
  license "MPL-2.0"
  head "https://github.com/p3bot/agentdex.git", branch: "main"
  ...
  def install
    ...
    ldflags = %W[
      ...
      -X github.com/p3bot/agentdex/internal/cli.Commit=56aaa3ce8d047d3af17fe275e1c1c3ecc5e4db86
